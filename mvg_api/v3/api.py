...
class MVGRequests:
    ...
    def location(
        ...
        return httpx.Request(
            "GET",
            f"{MVGRequests.url}api/fib/v3/location",
            params=param,
            headers=headers,
        )
    ...
    def messages(headers: Dict[str, str], message_type=Optional[str]) -> httpx.Request:
        ...
        return httpx.Request(
            "GET",
            f"{MVGRequests.url}api/fib/v3/message",
            params=param,
            headers=headers,
        )
    ...
    def connection(
        ...
        *,
        ...
        return httpx.Request(
            "GET",
            f"{MVGRequests.url}api/fib/v3/connection",
            params=param,
            headers=headers,
        )
    ...
    def lineinfo(headers: Dict[str, str], language: Optional[str]) -> httpx.Request:
        return httpx.Request(
            "GET", f"{MVGRequests.url}api/fib/v3/lineinfo/{language}", headers=headers
        )
    ...
    def stations(
        ...
        return httpx.Request(
            "GET", f"{MVGRequests.url}api/fib/v3/station", headers=headers, params=param
        )

    @staticmethod
    def lines(headers: Dict[str, str]):
        return httpx.Request(
            "GET", f"{MVGRequests.url}api/fib/v3/line", headers=headers
        )
    ...
    def zoom_station(div_id: int, headers: Dict[str, str]) -> httpx.Request:
        return httpx.Request(
            "GET",
            f"{MVGRequests.url}api/fib/v3/mvgzoomstation/{div_id}",
            headers=headers,
        )
    ...
    def plan(div_id: int, headers: Dict[str, str]) -> httpx.Request:
        return httpx.Request(
            "GET",
            f"{MVGRequests.url}api/fib/v3/mvgzoomstation/{div_id}/map",
            headers=headers,
        )
    ...
    def zoom_station_out_of_order(
        ...
        return httpx.Request(
            "GET",
            f"{MVGRequests.url}api/fib/v3/mvgzoomstation/{div_id}/outoforder",
            headers=headers,
        )
    ...
    def vehicle(
        ...
        return httpx.Request(
            "GET", f"{MVGRequests.url}api/fib/v3/vehicle", params=param, headers=headers
        )
    ...
    def surrounding_plan(
        ...
        url = f"{MVGRequests.url}api/fib/v3/surroundingplan/{plan_id}"
    ...
    def surrounding_plans(
        ...
        return httpx.Request(
            "GET",
            f"{MVGRequests.url}api/fib/v3/surroundingplan",
            params=params,
            headers=headers,
        )
