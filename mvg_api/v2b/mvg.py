...
from mvg_api.v2b.api import SyncApi, AsyncApi
from mvg_api.v2b.schemas.connection import Connections
from mvg_api.v2b.schemas.departure import Departures
from mvg_api.v2b.schemas.location import LocationType, Location
        ...
        for location in locations:
            ...
            if location.type == LocationType.ADDRESS:
                if ratio(location_str, location.street) > 0.75:
                    return location
        raise Exception(f"no location found for {location_str}")
